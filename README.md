...
The course introduces traditional natural language processing tools and concepts such as Finite State Transducers, Hidden Markov Models , N-grams, embeddings, frequency domain approach to speech synthesis and recognition. The modern NLP DNN baseline using LSTMs and an Attention layer is also examined.
